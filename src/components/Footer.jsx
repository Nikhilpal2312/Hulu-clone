...
<footer class="bg-blue-100/80 font-sans dark:bg-gray-900">
    <div class="container px-6 py-12 mx-auto">
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            ...
            <div>
                ...
                <div class="flex flex-col items-start mt-5 space-y-2">
                    ...
                    <p class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:cursor-pointer hover:text-blue-500">Join Our Team</p>
                    <p class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:cursor-pointer hover:text-blue-500">Community</p>
            ...
            <div>
                <p class="font-semibold text-gray-800 dark:text-white">Download for</p>
        ...
        <p class="font-sans p-8 text-start md:text-center md:text-lg md:p-4">© 2023 Hulu. All rights reserved.</p>
    </div>
</footer>
    </>
  )
